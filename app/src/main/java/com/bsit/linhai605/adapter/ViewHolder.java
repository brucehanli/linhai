...
public class ViewHolder extends RecyclerView.ViewHolder {
     ...
     * 关于事件的
     */
    public ViewHolder setOnItemClickListener(final int position, final OnItemClickListener listener) {
    ...
    public ViewHolder setOnClickListener(final int position, int viewId,
