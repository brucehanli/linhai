package com.bsit.linhai605.bluetooth;
...
public class BtBase {
    ...
    private static final String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/linhai/";
    ...
    private void notifyUI(final int state, final Object obj) {
        BaseApplication.runUi(new Runnable() {
            @Override
            public void run() {
                try {
                    if (mListener != null)
